 ...
 * @subpackage Example
 * @version    2.6.1 for plugin Uli Plugin Manager
...
add_action( 'tgmpa_register', 'uli_plugin_manager_register_required_plugins' );
 ...
 */
function uli_plugin_manager_register_required_plugins() {
	/*
	...
	$config = array(
		...
		/*
		'strings'      => array(
			'page_title'                      => __( 'Install Required Plugins', 'uli-plugin-manager' ),
			'menu_title'                      => __( 'Install Plugins', 'uli-plugin-manager' ),
